...
from .views import (HomePageView, AboutPageView, ListCustomers,CustomersDetailView,CustomerCreateView,CustomersUpdateView,CustomersDeleteView,
                    PricingPageView,DashBoardPageView,TargetClientListView,SearchClientView)
...
path('seach/',SearchClientView.as_view(),name="search-client"),
path('target/list_client',TargetClientListView.as_view(),name='list-target-client')
